      ...
      <div className="relative z-10 pt-32 px-6 max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto mb-20">
          {features.map((feature, i) => (
            <div key={i} className=" bg-white/ dark:bg-slate-900/0 dark:bg-[rgba(22,15,36,0.55)] border border-[var(--ig-border)] dark:border-[rgba(138,83,214,0.15)] rounded-[1.5rem] p-8 flex items-start gap-6 hover:border-[#8A53D6]/40 dark:hover:border-[#8A53D6]/50 transition-all duration-300 shadow-sm hover:shadow-md">
        ...
        <div className=" bg-white/ dark:bg-slate-900/0 dark:bg-[rgba(22,15,36,0.55)] border border-[var(--ig-border)] dark:border-[rgba(138,83,214,0.15)] rounded-[2rem] p-8 md:p-12 text-center max-w-4xl mx-auto shadow-sm relative overflow-hidden">
